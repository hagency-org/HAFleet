...
| R-010 | P1 | Remote CLI | Remote CLI advertises commands that are not packaged. | Make CLI command surface profile-aware; include targets or stop advertising unsupported remote commands. | Remote dispatch-target existence test. | Pending; design refined in `10-remote-local-roadmap.md` |
