...
- Phase 2-7 resumption is staged in `15`; RLP4-A MCP media cache relocation, RLP2-A runtime observation provenance, and RLP6-A profile-scoped help/docs are implemented, with the next safe batches still approval-gated.
