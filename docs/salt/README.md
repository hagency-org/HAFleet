...
- Phase 2-7 resumption is staged in `15`; RLP4-A MCP media cache relocation, RLP2-A runtime observation provenance, RLP6-A profile-scoped help/docs, and RLP3-A auth readiness diagnostics are implemented, with the next safe batches still approval-gated.
