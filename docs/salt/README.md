...
- The rhodes1 recovery and old-relay auto-update design are documented in `18`; implementation is decision-gated, with fleet inventory and standalone update guard recommended first.
