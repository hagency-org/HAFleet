...
| --- | --- | --- |
| `docs/Hibiki/**` | Personal/historical work docs; describe older `docs/{agent}` habits and prior designs. | Archive or keep clearly marked as personal history. |
...
| `docs/Hibiki/supervisor-fusion-design.md` | Proposes a direction that diverges from current backend Supervisor implementation. | Archive as historical design. |
...
| `ROADMAP-remote.md` | Reads like future roadmap although remote support exists. | Rename/archive or rewrite as current remote status. |
