 ...
 */
function overCommitMessage(e, alloc, remainingTokens, ctx) {
...
export function createEngagementStore({ load, persist, now = () => Date.now() } = {}) {
  ...
  return {
     ...
     */
    decide({ engagementId, approve, allocatedTokens, remainingTokens, by, reason, spendContext = null }) {
