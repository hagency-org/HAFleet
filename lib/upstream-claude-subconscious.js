...
const AGENT_CHAT_ROOT = String(process.env.AGENT_CHAT_ROOT || REPO_ROOT).trim() || REPO_ROOT;
const DEFAULT_UPSTREAM_CLAUDE_SUBCONSCIOUS_ROOT = path.resolve(AGENT_CHAT_ROOT, '..', 'claude-subconscious');
