...
<main class="page">
  <header class="header">
    <div class="title-wrap">
      <div class="eyebrow">hafleet operations</div>
      <h1>PROJECT BOARD</h1>
    </div>
    <nav class="nav" aria-label="Dashboard">
      <a href="/">Monitor</a><a href="/projects" aria-current="page">Projects</a><a href="/tasks">Tasks</a><a href="/pool">Pool</a><a href="/alerts">Alerts</a><a href="/config">Config</a><a href="/project-sides">Sides</a>
