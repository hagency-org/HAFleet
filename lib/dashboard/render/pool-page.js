...
// The vocabulary, not a copy of it. These were hardcoded literals in the browser
// script below — a second and third copy of the role and tier lists that nothing
// could hold to the first, so the grid would have kept rendering six columns after
// a seventh role was added.
import { ROLES, CAPABILITY_TIERS } from '../../matrix-agent.js';
...
// Interpolated from lib/role-capacity.json via matrix-agent.js at render time.
const TIERS=${JSON.stringify(CAPABILITY_TIERS)};
