...
(() => {
  ...
  function hasUnsavedDetailChanges(detail, supervisorControl) {
  ...
  function syncDetailDirtyStatus() {
    ...
    if (hasUnsavedDetailChanges(latestAgentDetail, latestSupervisorControl)) {
  ...
  function buildPageModel(detail, statusRow, supervisorDetail, supervisorStatus, supervisorControl, unreadPayload, queueItems, allStatusRows) {
