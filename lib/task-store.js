...
export function createTaskStore({ initialData, save }) {
  ...
  function transitionTask(id, newStatus, extra = {}) {
    ...
    if (newStatus === 'blocked') {
      task.waiting_reason = normalizeText(extra.waiting_reason, 1024) || task.waiting_reason;
      task.waiting_until = normalizeText(extra.waiting_until, 64) || task.waiting_until;
    }
  ...
  return { createTask, getTask, listTasks, updateTask, transitionTask, deleteTask, dump };
}
