 ...
 */
export function createAppserviceRouter({ sides = [] } = {}) {
  ...
  async function handle(request = {}) {
    ...
    if (!match) {
      /*
       * Identical to a single receiver's refusal, and deliberately says nothing about how many sides
       * exist or whether the path would have been recognised.
       */
      return { status: 403, body: { errcode: 'M_FORBIDDEN', error: 'bad hs_token' } };
    }
