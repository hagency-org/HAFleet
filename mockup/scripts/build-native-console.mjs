...
for (const name of ['layout.jsx', 'globals.css', 'usage/page.jsx', 'resources/page.jsx', 'resources/new/page.jsx', 'alerts/page.jsx', 'engagements/page.jsx']) await cp(join(source, 'app', name), join(staged, 'app', name));
...
const files = ['usage/index.html', 'resources/index.html', 'resources/new/index.html', 'alerts/index.html', 'engagements/index.html'];
...
const mime = (path) => ['usage/index.html', 'resources/index.html', 'resources/new/index.html', 'alerts/index.html', 'engagements/index.html'].includes(path) ? 'text/html; charset=utf-8'
